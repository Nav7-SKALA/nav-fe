...
//         sendInitialMessage(greeting);
//       }
//       // 일반 사용자가 질문했을 경우
//       else if (state?.message) {
//         sendInitialMessage(state.message);
//         navigate(location.pathname, { replace: true, state: {} }); // message만 비움
//       }
//     }
//   }, [
//     state?.message,
...
//   return (
//     <ChatPageContainer>
//       <Header username={memberName} />
//       <ChatContainer>
//         <ChatContent ref={scrollRef}>
//           {state?.isRoleModel && state.roleModelInfo && <RoleModelProfileCard {...state.roleModelInfo} />}
